...
namespace Shopping\Seller\Http\Requests;
...
class SellerRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('seller');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access seller module,
    ...
    {
        return user()->canDo('seller.seller.view');
    }
}
