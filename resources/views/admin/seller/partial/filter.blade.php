<div class="btn-group seller-seller">
...
$(document).ready(function(){
    ...
    $(".seller-seller .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/seller.seller.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".seller-seller .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.seller-seller .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'seller.seller.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#seller-seller-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#seller-seller-list .btn-reset-filter').css('display', 'none');
